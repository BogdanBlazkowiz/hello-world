...
player2 = Player(WIDTH_PLAYER, position2, (0, 255, 255), False, 3, 1)
...
while running:
    ...
    print(rect_player1[0], rect_player1[0])
    ...
    if pressed[pygame.K_LEFT] and not player1.dead and not direction1 == (1, 0):
        direction1 = (-1, 0)
    if pressed[pygame.K_DOWN] and not player1.dead and not direction1 == (0, -1):
        direction1 = (0, 1)
    if pressed[pygame.K_UP] and not player1.dead and not direction1 == (0, 1):
        direction1 = (0, -1)
    if pressed[pygame.K_RIGHT] and not player1.dead and not direction1 == (-1, 0):
        direction1 = (1, 0)
    if pressed[pygame.K_z] and not player2.dead and not direction2 == (0, 1):
        direction2 = (0, -1)
    if pressed[pygame.K_d] and not player2.dead and not direction2 == (-1, 0):
        direction2 = (1, 0)
    if pressed[pygame.K_q] and not player2.dead and not direction2 == (1, 0):
        direction2 = (-1, 0)
    if pressed[pygame.K_s] and not player2.dead and not direction2 == (0, -1):
        direction2 = (0, 1)
    if pressed[pygame.K_f] and not player3.dead and not direction3 == (1, 0):
        direction3 = (-1, 0)
    if pressed[pygame.K_g] and not player3.dead and not direction3 == (0, -1):
        direction3 = (0, 1)
    if pressed[pygame.K_t] and not player3.dead and not direction3 == (0, 1):
        direction3 = (0, -1)
    if pressed[pygame.K_h] and not player3.dead and not direction3 == (-1, 0):
        direction3 = (1, 0)
    if pressed[pygame.K_i] and not player4.dead and not direction4 == (0, 1):
        direction4 = (0, -1)
    if pressed[pygame.K_l] and not player4.dead and not direction4 == (-1, 0):
        direction4 = (1, 0)
    if pressed[pygame.K_j] and not player4.dead and not direction4 == (1, 0):
        direction4 = (-1, 0)
    if pressed[pygame.K_k] and not player4.dead and not direction4 == (0, -1):
        direction4 = (0, 1)
    if pressed[pygame.K_ESCAPE]:
        pygame.quit()
        sys.exit()
    if player1.dead and player2.dead and player3.dead:
        text_win4, rect = GAME_FONT.render(
            "T'as gagné pd", player4.color)
        screen.blit(text_win4, (640, 320))
        running = False
    if player1.dead and player2.dead and player4.dead:
        text_win3, rect = GAME_FONT.render(
            "T'as gagné pd", player3.color)
        screen.blit(text_win3, (640, 320))
        running = False
    if player1.dead and player4.dead and player3.dead:
        text_win2, rect = GAME_FONT.render(
            "T'as gagné pd", player2.color)
        screen.blit(text_win2, (640, 320))
        running = False
    if player4.dead and player2.dead and player3.dead:
        text_win1, rect = GAME_FONT.render(
            "T'as gagné pd", player1.color)
        screen.blit(text_win1, (640, 320))
        running = False
    if player1.length < max_length:
        player1.length += 1
    if player2.length < max_length:
        player2.length += 1
    if player3.length < max_length:
        player3.length += 1
    if player4.length < max_length:
        player4.length += 1
